...
import {getMoviePopularityDescThunk} from "../../store/slices/movie.slice";
...
const MoviesPopularityDescPage: FC = () => {
    ...
    useEffect(() => {
        dispatch(getMoviePopularityDescThunk(currentPage));
    }, [currentPage])
...
export default MoviesPopularityDescPage;